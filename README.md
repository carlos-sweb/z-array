...
- ✅ **100% ECMAScript Compatible**: Implements all standard array methods (push, pop, map, filter, reduce, etc.)
...
| `fill(value, start, end)` | `array.fill()` | Fill array with value |
...
- `groupBy(K, ctx, keyFn)` - Group by key function
